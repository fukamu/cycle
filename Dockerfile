...
FROM golang:1.27.1-alpine@sha256:cf6fca6641884b8433441b2b0652976f975e1d0fdd26d177eaaf8596087f3125 AS backend-build
WORKDIR /src/backend
...
LABEL org.opencontainers.image.title="FUKAMU Cycle backend" \
    org.opencontainers.image.description="Backend service for FUKAMU Cycle"
WORKDIR /app
