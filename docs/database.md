...
`000009` downは破棄可能なlocal test DB専用です。どちらかのcompanion tableにrowが1件でもあればSQLSTATE `23514`でMigration全体をfail-closedにし、success signalを破棄・空文字化・parent rowへ埋め戻ししません。両tableが空の場合だけdropできます。
