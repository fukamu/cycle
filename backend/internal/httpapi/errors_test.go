...
func TestClassifyErrorMatchesPublicStatusCodeMatrix(t *testing.T) {
	tests := []struct {
		...
		{"Cycle Replan confirmation", workspace.ErrReplanConfirmation, 400, "CYCLE_REPLAN_CONFIRMATION_REQUIRED"},
		...
		{"cycle replan fallback", errCycleReplanFailed, 500, "CYCLE_REPLAN_FAILED"},
