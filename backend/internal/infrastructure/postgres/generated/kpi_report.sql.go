...
const aggregateSurvivorFunnelKPI = `-- name: AggregateSurvivorFunnelKPI :one
WITH report_input AS (
    SELECT
        $1::timestamptz AS cohort_start,
        $2::timestamptz AS cohort_end,
...
funnel_events AS (
    SELECT
        funnel_base.goal_started_at, funnel_base.terminal_at, funnel_base.cycle_one_completed_at, funnel_base.cycle_two_id, funnel_base.cycle_two_started_at, funnel_base.cycle_three_started_at,
...
funnel_outcomes AS (
    SELECT
        funnel_events.goal_started_at, funnel_events.terminal_at, funnel_events.cycle_one_completed_at, funnel_events.cycle_two_id, funnel_events.cycle_two_started_at, funnel_events.cycle_three_started_at, funnel_events.cycle_one_succeeded, funnel_events.review_decision_at, funnel_events.review_decision_kind,
        cycle_one_succeeded
...
type AggregateSurvivorFunnelKPIParams struct {
	CohortStart pgtype.Timestamptz
	CohortEnd   pgtype.Timestamptz
	AsOf        pgtype.Timestamptz
}

type AggregateSurvivorFunnelKPIRow struct {
	RepeatableRead               bool
	ReadOnly                     bool
	ActivationDenominator        int64
	ActivationNumerator          int64
	ActivationDurationCount      int64
	ActivationDurationP50Seconds float64
	ActivationDurationP90Seconds float64
	FirstGoalDenominator         int64
	CycleOneCompleted            int64
	ReviewDecision               int64
	NextCycleDecision            int64
	TerminalReviewDecision       int64
	CycleTwoStarted              int64
	CycleThreeStarted            int64
	CycleOneDurationCount        int64
	CycleOneDurationP50Seconds   float64
	CycleOneDurationP90Seconds   float64
	DecisionDurationCount        int64
	DecisionDurationP50Seconds   float64
	DecisionDurationP90Seconds   float64
}

func (q *Queries) AggregateSurvivorFunnelKPI(ctx context.Context, arg AggregateSurvivorFunnelKPIParams) (*AggregateSurvivorFunnelKPIRow, error) {
	row := q.db.QueryRow(ctx, aggregateSurvivorFunnelKPI, arg.CohortStart, arg.CohortEnd, arg.AsOf)
	var i AggregateSurvivorFunnelKPIRow
	err := row.Scan(
		&i.RepeatableRead,
		&i.ReadOnly,
		&i.ActivationDenominator,
		&i.ActivationNumerator,
		&i.ActivationDurationCount,
		&i.ActivationDurationP50Seconds,
		&i.ActivationDurationP90Seconds,
		&i.FirstGoalDenominator,
		&i.CycleOneCompleted,
		&i.ReviewDecision,
		&i.NextCycleDecision,
		&i.TerminalReviewDecision,
		&i.CycleTwoStarted,
		&i.CycleThreeStarted,
		&i.CycleOneDurationCount,
		&i.CycleOneDurationP50Seconds,
		&i.CycleOneDurationP90Seconds,
		&i.DecisionDurationCount,
		&i.DecisionDurationP50Seconds,
		&i.DecisionDurationP90Seconds,
	)
	return &i, err
}
