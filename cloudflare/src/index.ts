...
export class Backend extends Container {
  ...
  envVars = {
    ...
    CONTENT_ENCRYPTION_KMS_PROVIDER: "gcp",
    CONTENT_ENCRYPTION_GCP_KEY_VERSION: required(
      "CONTENT_ENCRYPTION_GCP_KEY_VERSION",
      env.CONTENT_ENCRYPTION_GCP_KEY_VERSION,
    ),
    CONTENT_ENCRYPTION_GCP_CREDENTIALS_JSON: required(
      "CONTENT_ENCRYPTION_GCP_CREDENTIALS_JSON",
      env.CONTENT_ENCRYPTION_GCP_CREDENTIALS_JSON,
    ),
