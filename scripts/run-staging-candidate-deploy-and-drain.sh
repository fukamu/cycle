...
required=(
  ...
  CONTENT_ENCRYPTION_GCP_CREDENTIALS_JSON TURNSTILE_SECRET_KEY AI_MODEL
)
...
variable_names=(
  ...
  DB_MAX_IDLE_CONNS DB_CONN_MAX_LIFETIME_MINUTES CONTENT_ENCRYPTION_GCP_KEY_VERSION
